...
import time
# from dsUpdate_script import Tracker
...
tracker = DeepSort(max_age=20,n_init=2,nms_max_overlap=0.3,max_cosine_distance=0.3)
...
while cap.isOpened():
    ...
    for result in results: 
        ...
        for r in result.boxes.data.tolist():
            ...
            detections.append(([int(x1), int(y1), int(x2), int(y2)], score, int(id)))
